...
/**
 * \def _USART_BUFFER_LENGTH_TX_
 * \brief Defini la taille du buffer pour la transmission
 */
//     <o.0..9>   Taille du buffer TX (_USART_BUFFER_LENGTH_TX_)  <1-512>
#define _USART_BUFFER_LENGTH_TX_ 64

/**
 * \def _USART_BUFFER_LENGTH_RX_
 * \brief Defini la taille du buffer pour la Reception
 */
//     <o.0..16>   Taille du buffer RX (_USART_BUFFER_LENGTH_RX_)  <1-40960>
#define _USART_BUFFER_LENGTH_RX_ 37888
