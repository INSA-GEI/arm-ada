...
package ada_main is
   ...
   u00010 : constant Version_32 := 16#bc150ac8#;
   ...
   u00057 : constant Version_32 := 16#3d7bc4a0#;
   pragma Export (C, u00057, "tortueB");
   u00058 : constant Version_32 := 16#0919aee4#;
   pragma Export (C, u00058, "tortueS");
   u00059 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00059, "ada__numericsS");
   u00060 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00060, "ada__numerics__elementary_functionsB");
   u00061 : constant Version_32 := 16#00443200#;
   pragma Export (C, u00061, "ada__numerics__elementary_functionsS");
   u00062 : constant Version_32 := 16#0cdfa324#;
   pragma Export (C, u00062, "ada__numerics__auxS");
   u00063 : constant Version_32 := 16#6c05c057#;
   pragma Export (C, u00063, "system__exn_llfB");
   u00064 : constant Version_32 := 16#b52a9e68#;
   pragma Export (C, u00064, "system__exn_llfS");
   u00065 : constant Version_32 := 16#512139a0#;
   pragma Export (C, u00065, "system__fat_fltS");
   u00066 : constant Version_32 := 16#940c8174#;
   pragma Export (C, u00066, "system__unsigned_typesS");
   u00067 : constant Version_32 := 16#c1a106e2#;
   pragma Export (C, u00067, "ada__text_ioB");
   u00068 : constant Version_32 := 16#e701a999#;
   pragma Export (C, u00068, "ada__text_ioS");
   u00069 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00069, "ada__streamsB");
   u00070 : constant Version_32 := 16#2e6701ab#;
   pragma Export (C, u00070, "ada__streamsS");
   u00071 : constant Version_32 := 16#db5c917c#;
   pragma Export (C, u00071, "ada__io_exceptionsS");
   u00072 : constant Version_32 := 16#920eada5#;
   pragma Export (C, u00072, "ada__tagsB");
   u00073 : constant Version_32 := 16#13ca27f3#;
   pragma Export (C, u00073, "ada__tagsS");
   u00074 : constant Version_32 := 16#c3335bfd#;
   pragma Export (C, u00074, "system__htableB");
   u00075 : constant Version_32 := 16#8d96965e#;
   pragma Export (C, u00075, "system__htableS");
   u00076 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00076, "system__string_hashB");
   u00077 : constant Version_32 := 16#2fc8fd20#;
   pragma Export (C, u00077, "system__string_hashS");
   u00078 : constant Version_32 := 16#b44f9ae7#;
   pragma Export (C, u00078, "system__val_unsB");
   u00079 : constant Version_32 := 16#84a46c4f#;
   pragma Export (C, u00079, "system__val_unsS");
   u00080 : constant Version_32 := 16#27b600b2#;
   pragma Export (C, u00080, "system__val_utilB");
   u00081 : constant Version_32 := 16#a5f4934a#;
   pragma Export (C, u00081, "system__val_utilS");
   u00082 : constant Version_32 := 16#d1060688#;
   pragma Export (C, u00082, "system__case_utilB");
   u00083 : constant Version_32 := 16#2d5d4c63#;
   pragma Export (C, u00083, "system__case_utilS");
   u00084 : constant Version_32 := 16#84a27f0d#;
   pragma Export (C, u00084, "interfaces__c_streamsB");
   u00085 : constant Version_32 := 16#a06e9ee4#;
   pragma Export (C, u00085, "interfaces__c_streamsS");
   u00086 : constant Version_32 := 16#79c5f3ba#;
   pragma Export (C, u00086, "system__crtlS");
   u00087 : constant Version_32 := 16#f1dc49a7#;
   pragma Export (C, u00087, "system__file_ioB");
   u00088 : constant Version_32 := 16#ae25c4d1#;
   pragma Export (C, u00088, "system__file_ioS");
   u00089 : constant Version_32 := 16#cf417de3#;
   pragma Export (C, u00089, "ada__finalizationS");
   u00090 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00090, "system__finalization_rootB");
   u00091 : constant Version_32 := 16#46a65624#;
   pragma Export (C, u00091, "system__finalization_rootS");
   u00092 : constant Version_32 := 16#769e25e6#;
   pragma Export (C, u00092, "interfaces__cB");
   u00093 : constant Version_32 := 16#61e3d2ff#;
   pragma Export (C, u00093, "interfaces__cS");
   u00094 : constant Version_32 := 16#d301c7de#;
   pragma Export (C, u00094, "system__os_libB");
   u00095 : constant Version_32 := 16#dc0cac3f#;
   pragma Export (C, u00095, "system__os_libS");
   u00096 : constant Version_32 := 16#1a817b8e#;
   pragma Export (C, u00096, "system__stringsB");
   u00097 : constant Version_32 := 16#77eb34d2#;
   pragma Export (C, u00097, "system__stringsS");
   u00098 : constant Version_32 := 16#f4cbbf1c#;
   pragma Export (C, u00098, "system__file_control_blockS");
   u00099 : constant Version_32 := 16#58e7cff7#;
   pragma Export (C, u00099, "system__memoryB");
   u00100 : constant Version_32 := 16#50294380#;
