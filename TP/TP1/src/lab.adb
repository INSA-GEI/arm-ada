...
package body Lab is
   ...
   begin
      ...
      Pacman_Gauche_Sprite := Unpackimage(Ressources.Pacman_Gauche);
      Pacman_Droit_Sprite := Unpackimage(Ressources.Pacman_Droit);
      Pacman_Haut_Sprite := Unpackimage(Ressources.Pacman_Haut);
      Pacman_Bas_Sprite := Unpackimage(Ressources.Pacman_Bas);
      Cerise_Sprite := Unpackimage(Ressources.Cerise);
      Mur_Sprite := Unpackimage(Ressources.Mur);
