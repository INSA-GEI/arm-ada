...
package ada_main is
   ...
   u00004 : constant Version_32 := 16#eb3a882a#;
   pragma Export (C, u00004, "magnetoB");
   u00005 : constant Version_32 := 16#523a8087#;
   ...
   u00118 : constant Version_32 := 16#4c77a326#;
   ...
   u00122 : constant Version_32 := 16#8f828546#;
   pragma Export (C, u00122, "system__img_realB");
   u00123 : constant Version_32 := 16#d9ae7b96#;
   ...
   u00127 : constant Version_32 := 16#54da27e6#;
   pragma Export (C, u00127, "system__img_lluB");
   u00128 : constant Version_32 := 16#51339ed5#;
   ...
   u00139 : constant Version_32 := 16#db42ae56#;
   pragma Export (C, u00139, "system__img_biuB");
   u00140 : constant Version_32 := 16#ded8165b#;
   pragma Export (C, u00140, "system__img_biuS");
   u00141 : constant Version_32 := 16#244fa59d#;
   pragma Export (C, u00141, "system__img_llbB");
   u00142 : constant Version_32 := 16#9f1f06a5#;
   ...
   u00145 : constant Version_32 := 16#cd1fde06#;
   pragma Export (C, u00145, "system__img_llwB");
   u00146 : constant Version_32 := 16#36732533#;
   pragma Export (C, u00146, "system__img_llwS");
   u00147 : constant Version_32 := 16#811cd12a#;
   pragma Export (C, u00147, "system__img_wiuB");
   u00148 : constant Version_32 := 16#b09991c9#;
   pragma Export (C, u00148, "system__img_wiuS");
   u00149 : constant Version_32 := 16#65de8d35#;
   pragma Export (C, u00149, "system__val_intB");
   u00150 : constant Version_32 := 16#f3ca8567#;
   pragma Export (C, u00150, "system__val_intS");
   u00151 : constant Version_32 := 16#5276dcb7#;
   pragma Export (C, u00151, "system__val_unsB");
   u00152 : constant Version_32 := 16#2dfce3af#;
   pragma Export (C, u00152, "system__val_unsS");
   u00153 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00153, "ada__numericsS");
   u00154 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00154, "ada__numerics__elementary_functionsB");
   u00155 : constant Version_32 := 16#edc89b7f#;
   pragma Export (C, u00155, "ada__numerics__elementary_functionsS");
   u00156 : constant Version_32 := 16#e5114ee9#;
   pragma Export (C, u00156, "ada__numerics__auxB");
   u00157 : constant Version_32 := 16#9f6e24ed#;
   pragma Export (C, u00157, "ada__numerics__auxS");
   u00158 : constant Version_32 := 16#2b5d4b05#;
   pragma Export (C, u00158, "system__machine_codeS");
   u00159 : constant Version_32 := 16#08c9efdf#;
   pragma Export (C, u00159, "insaB");
   u00160 : constant Version_32 := 16#0830a824#;
   pragma Export (C, u00160, "insaS");
   u00161 : constant Version_32 := 16#ffaa9e94#;
   pragma Export (C, u00161, "ada__calendar__delaysB");
   u00162 : constant Version_32 := 16#d86d2f1d#;
   pragma Export (C, u00162, "ada__calendar__delaysS");
   u00163 : constant Version_32 := 16#c47dab26#;
   pragma Export (C, u00163, "ada__calendarB");
   u00164 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00164, "ada__calendarS");
   u00165 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00165, "system__os_primitivesB");
   u00166 : constant Version_32 := 16#41c889f2#;
   pragma Export (C, u00166, "system__os_primitivesS");
   u00167 : constant Version_32 := 16#eeb230e3#;
   pragma Export (C, u00167, "system__arith_64B");
   u00168 : constant Version_32 := 16#5ccd1b9e#;
   pragma Export (C, u00168, "system__arith_64S");
   u00169 : constant Version_32 := 16#4b065625#;
   pragma Export (C, u00169, "insa__graphicsB");
   u00170 : constant Version_32 := 16#e10b47ab#;
   pragma Export (C, u00170, "insa__graphicsS");
   u00171 : constant Version_32 := 16#9b3f2fbb#;
   pragma Export (C, u00171, "insa__simulatorB");
   u00172 : constant Version_32 := 16#6bc03587#;
   pragma Export (C, u00172, "insa__simulatorS");
   u00173 : constant Version_32 := 16#97ae1e3d#;
   pragma Export (C, u00173, "ada__strings__fixedB");
   u00174 : constant Version_32 := 16#fec1aafc#;
   pragma Export (C, u00174, "ada__strings__fixedS");
   u00175 : constant Version_32 := 16#60da0992#;
   ...
   u00177 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00177, "gnatS");
   u00178 : constant Version_32 := 16#a55269e4#;
   pragma Export (C, u00178, "gnat__exception_tracesS");
   u00179 : constant Version_32 := 16#9c857b76#;
   pragma Export (C, u00179, "gnat__source_infoS");
   u00180 : constant Version_32 := 16#dbf24c7a#;
   pragma Export (C, u00180, "gnat__string_splitB");
   u00181 : constant Version_32 := 16#3d848bbe#;
   pragma Export (C, u00181, "gnat__string_splitS");
   u00182 : constant Version_32 := 16#d5d8c501#;
   pragma Export (C, u00182, "system__storage_pools__subpoolsB");
   u00183 : constant Version_32 := 16#e136d7bf#;
   ...
   u00190 : constant Version_32 := 16#84042202#;
   pragma Export (C, u00190, "system__storage_pools__subpools__finalizationB");
   u00191 : constant Version_32 := 16#8bd8fdc9#;
   pragma Export (C, u00191, "system__storage_pools__subpools__finalizationS");
   u00192 : constant Version_32 := 16#5252521d#;
   pragma Export (C, u00192, "system__stream_attributesB");
   u00193 : constant Version_32 := 16#d573b948#;
   pragma Export (C, u00193, "system__stream_attributesS");
   u00194 : constant Version_32 := 16#3e25f63c#;
   pragma Export (C, u00194, "system__stream_attributes__xdrB");
   u00195 : constant Version_32 := 16#2f60cd1f#;
   pragma Export (C, u00195, "system__stream_attributes__xdrS");
   u00196 : constant Version_32 := 16#3872f91d#;
   pragma Export (C, u00196, "system__fat_lfltS");
   u00197 : constant Version_32 := 16#ed063051#;
   pragma Export (C, u00197, "system__fat_sfltS");
   u00198 : constant Version_32 := 16#3c02db67#;
   pragma Export (C, u00198, "insa__keysB");
   u00199 : constant Version_32 := 16#9b861e2b#;
   pragma Export (C, u00199, "insa__keysS");
   u00200 : constant Version_32 := 16#23404289#;
   pragma Export (C, u00200, "insa__simulator__tasksB");
   u00201 : constant Version_32 := 16#017bbd9d#;
   pragma Export (C, u00201, "insa__simulator__tasksS");
   u00202 : constant Version_32 := 16#75032d8f#;
   pragma Export (C, u00202, "insa__timerB");
   u00203 : constant Version_32 := 16#ac2dea83#;
   pragma Export (C, u00203, "insa__timerS");
   u00204 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00204, "system__concat_2B");
   u00205 : constant Version_32 := 16#44953bd4#;
   pragma Export (C, u00205, "system__concat_2S");
   u00206 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00206, "system__concat_5B");
   u00207 : constant Version_32 := 16#c16baf2a#;
   ...
   u00210 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00210, "system__concat_3B");
   u00211 : constant Version_32 := 16#4d45b0a1#;
   pragma Export (C, u00211, "system__concat_3S");
   u00212 : constant Version_32 := 16#021224f8#;
   pragma Export (C, u00212, "system__pool_globalB");
   u00213 : constant Version_32 := 16#29da5924#;
   pragma Export (C, u00213, "system__pool_globalS");
   ...
   u00216 : constant Version_32 := 16#82d0901e#;
   pragma Export (C, u00216, "insa__sensorsB");
   u00217 : constant Version_32 := 16#f9e60fe4#;
   pragma Export (C, u00217, "insa__sensorsS");
   u00218 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00218, "system__concat_6B");
   u00219 : constant Version_32 := 16#94f2c1b6#;
   pragma Export (C, u00219, "system__concat_6S");
   u00220 : constant Version_32 := 16#46b1f5ea#;
   pragma Export (C, u00220, "system__concat_8B");
   u00221 : constant Version_32 := 16#a532a1d3#;
   pragma Export (C, u00221, "system__concat_8S");
   u00222 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00222, "system__concat_7B");
   u00223 : constant Version_32 := 16#baf2b71b#;
   pragma Export (C, u00223, "system__concat_7S");
   u00224 : constant Version_32 := 16#2bcc8550#;
   pragma Export (C, u00224, "insa__graphics__uiB");
   u00225 : constant Version_32 := 16#84860005#;
   pragma Export (C, u00225, "insa__graphics__uiS");
