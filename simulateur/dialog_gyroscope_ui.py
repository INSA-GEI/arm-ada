...
# Form implementation generated from reading ui file 'ui/dialog_gyroscope.ui'
#
...
class Ui_DialogGyroscope(object):
    def setupUi(self, DialogGyroscope):
        DialogGyroscope.setObjectName("DialogGyroscope")
        DialogGyroscope.resize(379, 242)
        self.horizontalLayout = QtWidgets.QHBoxLayout(DialogGyroscope)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.labelX = QtWidgets.QLabel(DialogGyroscope)
        self.labelX.setAlignment(QtCore.Qt.AlignCenter)
        self.labelX.setObjectName("labelX")
        self.verticalLayout.addWidget(self.labelX)
        self.sliderX = QtWidgets.QSlider(DialogGyroscope)
        ...
        self.line_2 = QtWidgets.QFrame(DialogGyroscope)
        ...
        self.labelY = QtWidgets.QLabel(DialogGyroscope)
        ...
        self.sliderY = QtWidgets.QSlider(DialogGyroscope)
        ...
        self.retranslateUi(DialogGyroscope)
        QtCore.QMetaObject.connectSlotsByName(DialogGyroscope)

    def retranslateUi(self, DialogGyroscope):
        _translate = QtCore.QCoreApplication.translate
        DialogGyroscope.setWindowTitle(_translate("DialogGyroscope", "Gyroscope"))
        self.labelX.setText(_translate("DialogGyroscope", "Axe X = 0 g [0x00]"))
        self.labelZ.setText(_translate("DialogGyroscope", "Axe Z = 0 g [0x00]"))
        self.labelY.setText(_translate("DialogGyroscope", "Axe Y = 0 g [0x00]"))
