/*------------------------------------------------------------------------*/
/* STM32F700: MMCv3/SDv1/SDv2 (SPI mode) control module                   */
/*------------------------------------------------------------------------*/
/*
...
static void CopyBuffer(uint32_t* outBuf, const BYTE *inBuff);
...
void disk_timerproc (void)
{
	...
	if (BSP_SD_IsDetected()==SD_PRESENT) {	/* Card is in socket */
		s &= ~STA_NODISK;
	} else {		/* Socket empty */
