...
package body Simon is
   ...
   -- Pensez � inserer des newline pour eviter que les chaines soient trop longues
   ...
   -- Faire une petite pause entre 2 s�quences (par ex.)
   ...
   begin
      ...
      --     SYNTH_SetInstrument(I, Guitar_Access);	-- Parametrage de l'instrument à utiliser par canal
      --  
      --     I:=I+1;
      --  end loop;
      --  
   ...
   --------------------------------------------------------------------
   -- Partie priv�e
   -- Routine de support, ne doivent pas etre appel�e directement
   --------------------------------------------------------------------
   ...
   -- Affiche ou efface la touche bleu eclair�e
      ...
      if Efface then
         ...
         if SpritesTouches(Bleu)=null then
            ...
            SpritesTouches(Bleu):=CreateImage(SpritesTouchesCoord(Bleu).X,
                                              ...
                                              ALIGNEMENT_CENTER); -- TODO revoir les coordonn�es
   ...
   -- Affiche ou efface la touche rouge eclair�e
   ...
   -- Affiche ou efface la touche verte eclair�e
   ...
   -- Affiche ou efface la touche jaune eclair�e
   ...
   -- Retourne le temps ecoul� (en 100 ms)
