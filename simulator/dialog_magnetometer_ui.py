...
# Form implementation generated from reading ui file 'ui/dialog_magnetometer.ui'
#
...
class Ui_DialogMagnetometer(object):
    def setupUi(self, DialogMagnetometer):
        DialogMagnetometer.setObjectName("DialogMagnetometer")
        DialogMagnetometer.resize(376, 272)
        self.horizontalLayout = QtWidgets.QHBoxLayout(DialogMagnetometer)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.labelX = QtWidgets.QLabel(DialogMagnetometer)
        self.labelX.setAlignment(QtCore.Qt.AlignCenter)
        self.labelX.setObjectName("labelX")
        self.verticalLayout.addWidget(self.labelX)
        self.sliderX = QtWidgets.QSlider(DialogMagnetometer)
        ...
        self.line_2 = QtWidgets.QFrame(DialogMagnetometer)
        ...
        self.labelY = QtWidgets.QLabel(DialogMagnetometer)
        ...
        self.sliderY = QtWidgets.QSlider(DialogMagnetometer)
        ...
        self.retranslateUi(DialogMagnetometer)
        QtCore.QMetaObject.connectSlotsByName(DialogMagnetometer)

    def retranslateUi(self, DialogMagnetometer):
        _translate = QtCore.QCoreApplication.translate
        DialogMagnetometer.setWindowTitle(_translate("DialogMagnetometer", "Magnetometre"))
        self.labelX.setText(_translate("DialogMagnetometer", "Axe X = 0 g [0x00]"))
        self.labelZ.setText(_translate("DialogMagnetometer", "Axe Z = 0 g [0x00]"))
        self.labelY.setText(_translate("DialogMagnetometer", "Axe Y = 0 g [0x00]"))
